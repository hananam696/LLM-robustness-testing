...
│   │   ├── gsm-symbolic-results.xlsx
│   │   ├── gsm-symbolic-prompts.pdf
│   │   └── gsm-symbolic-report.pdf
│   │
│   └── reasoning-tasks/
│       ├── reasoning-prompts.docx
│       ├── reasoning-llm-responses.docx
│       ├── reasoning-evaluation-results.xlsx
│       └── reasoning-report.docx
│
└── coding-tasks/
    ├── coding-results.xlsx
    └── coding-report.docx
...
This evaluation investigates the robustness of LLM mathematical reasoning using prompt variations inspired by the GSM-Symbolic benchmark.

- **gsm-symbolic-prompts.pdf** — Prompt variations used during the evaluation.
- **gsm-symbolic-results.xlsx** — Raw responses generated by each evaluated LLM.
- **evaluation-results.xlsx** — Correct/incorrect evaluation for each prompt across all LLMs.
- **gsm-symbolic-report.pdf** — Methodology, analysis, discussion, and findings.

---

### reasoning-tasks/

This evaluation measures reasoning robustness using custom-designed arithmetic, logical reasoning, probability, and language ambiguity questions.

- **reasoning-prompts.docx** — Questions presented to each LLM.
- **reasoning-llm-responses.docx** — Responses generated by each evaluated LLM.
- **reasoning-evaluation-results.xlsx** — Correct/incorrect evaluation for every question.
- **reasoning-report.docx** — Complete methodology, analysis, and findings.

---

## coding-tasks/

This evaluation measures robustness of code generation under surface-level prompt variations.

- **coding-results.xlsx** — Correct/incorrect evaluation for each coding variation.
- **coding-report.docx** — Methodology, experimental design, analysis, and findings.
